...
::: columns
::: {.column width="55%"}
```{r plot_age, echo=FALSE, fig.height=4, fig.width=5}
plot_age
```
:::
...
```{r nei_plot, echo=FALSE, fig.width=10, message=FALSE, warning=FALSE}
nei_plot
```
...
Since the purpose of the model is to predict future audience movie scores, the approach used is Best Predictive Model (BPM).
